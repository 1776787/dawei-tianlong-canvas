                    ...
                    },
                    {
                        ...
                        children: (
                            <Form layout="vertical" requiredMark={false}>
                                ...
                                <div className="mt-6 mb-2 text-sm font-semibold">{t("config.preferences.runningHub")}</div>
                                <Form.Item label={t("config.preferences.runningHubApiKey")} extra={t("config.preferences.runningHubApiKeyHint")} className="mb-0">
                                    <Input.Password value={config.runningHubApiKey} onChange={(event) => updateConfig("runningHubApiKey", event.target.value)} />
                                </Form.Item>
                            </Form>
                        ),
                    },
